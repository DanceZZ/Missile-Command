...
/**
 * Represents one of the cities that the player must defend from incoming missiles.
 *
 * @author Alan Tibbetts
 * @since Feb 19, 2010, 2:44:32 PM
 */
public class City extends DefensiveObject {
    ...
    private final DefensiveObjectType type = DefensiveObjectType.CITY;
     ...
     */
    public City(Point2D.Double bottomLeftCoordinates) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("City created, coordinates: " + coordinates);
        }
    }
