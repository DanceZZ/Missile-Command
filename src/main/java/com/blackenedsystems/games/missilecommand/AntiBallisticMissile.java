 ...
 */
public class AntiBallisticMissile extends Missile {

    private final Logger logger = Logger.getLogger(AntiBallisticMissile.class);
     ...
     */
    public AntiBallisticMissile(Point2D.Double initialCoordinates, Point2D.Double targetCoordinates, int speed) {
